...
INSERT INTO fitUser (description, firstName, lastName, fullName, email, avatarUrl, providerId, authUserId) VALUES ('Ehemalige Miss Ostschweiz', 'Silvio', 'Jaeger', 'Silvio Jäger', 'silvio.jaeger@ntb.ch', 'https://i.ytimg.com/vi/UV79c5Ubn7s/hqdefault.jpg', 'facebook', '029387450923475');
INSERT INTO fitUser (description, firstName, lastName, fullName, email, avatarUrl, providerId, authUserId) VALUES ('Bester Basketballer unserer Zeit', 'LeBron', 'James', 'LeBron James', 'lbj@lakers23.nba', 'https://i.ytimg.com/vi/UV79c5Ubn7s/hqdefault.jpg', 'facebook', '654321687');
INSERT INTO fitUser (description, firstName, lastName, fullName, email, avatarUrl, providerId, authUserId) VALUES ('Bester Basler Export', 'Roger', 'Federer', 'Roger Federer', 'fedi@ch', 'https://i.ytimg.com/vi/UV79c5Ubn7s/hqdefault.jpg', 'facebook', '632318664554645');
INSERT INTO fitUser (description, firstName, lastName, fullName, email, avatarUrl, providerId, authUserId) VALUES ('Fussballer', 'Mo', 'Salah', 'Mo Salah', 'fasdf@ch', 'https://i.ytimg.com/vi/UV79c5Ubn7s/hqdefault.jpg', 'facebook', '235468654354');
